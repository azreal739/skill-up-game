...
export const apiMission007ReleaseRisk: MissionDefinition = {
  ...
  title: 'Release Risk',
  summary:
    'The fix is ready but the integration burned customers once. Choose a rollout that limits blast radius.',
  difficulty: 'hard',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      tags: ['api', 'cicd'],
      storyContext:
        'You want the fix live, but you want any residual surprise to hit a fraction of traffic, not everyone at once.',
      prompt: 'What is the safest way to release the corrected integration?',
      options: [
        {
          id: 'b',
          label:
            'Deploy to 100% immediately — the contract test is green, so nothing can go wrong',
          isCorrect: false,
          feedback:
            'A green contract test proves today’s payload matches; it cannot prove the back end won’t change tomorrow. Big-bang gives up the safety of a gradual rollout for no benefit.',
        },
        {
          id: 'a',
          label:
        ...
        },
        {
          id: 'c',
          label:
            'Hold the release until the back end promises never to change the DTO again',
          isCorrect: false,
          feedback:
            'You cannot freeze another team’s roadmap, and waiting leaves the current bug in production. Ship safely rather than waiting for a guarantee nobody can give.',
        },
      ],
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'How do you make a surprise hit a fraction of users instead of all of them?',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'The answer combines a gradual flag rollout with the contract test — not a big-bang or an indefinite hold.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content:
            'Release behind a flag, ramp gradually while monitoring, keep the contract test in CI.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: 1,
          reason:
            'An unflagged big-bang release would expose every user to the next drift at once.',
        },
      ],
      helpLinks: [
        {
      ...
      successFeedback:
        'Flag on for a small cohort, dashboards watched, contract test guarding CI — the release is observable and instantly reversible.',
      failureFeedback:
        'A green test doesn’t justify big-bang, and you can’t wait for a frozen DTO. Ship behind a flag and ramp gradually.',
    },
  ],
  reflectionPrompt:
    'What does a feature flag give you that a passing test alone cannot?',
