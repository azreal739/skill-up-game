...
export const cdnMission008BossRestoreTheEdge: MissionDefinition = {
  ...
  summary:
    'A deploy went out; users see the old app, some see white screens. Restore the edge and prove it.',
  difficulty: 'boss',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback:
            'The assets uploaded fine; the problem is the stale entry file pointing at old ones.',
        },
        {
          id: 'c',
          ...
          isCorrect: false,
          feedback:
            'Propagation is near-instant; the delay matches the index.html TTL.',
        },
        {
          id: 'a',
          label:
            'The edge is serving a cached index.html (max-age 10800) that still points at the old hashed assets',
          isCorrect: true,
          feedback:
            'The reused-URL entry file is cached, so users get the old map to the app.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Which file reuses its URL and is cached?',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'A cached index.html is a stale map to the app.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'It is the entry file’s TTL, not the assets.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'A cached index.html pointing at old assets.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: 1,
          reason:
            'Misreading the stale edge sent the response chasing healthy assets.',
        },
      ],
      helpLinks: [
      ...
      failureFeedback:
        'The assets are fine — it is the cached, reused-URL index.html.',
    },
    {
      ...
      options: [
        {
          id: 'a',
          label:
            'Serve index.html (and other reused-URL files) no-cache / very short TTL; keep hashed assets immutable',
          isCorrect: true,
          feedback:
            'Entry files that reuse URLs must stay fresh; hashed assets can stay immutable.',
        },
        {
          id: 'b',
          ...
          isCorrect: false,
          feedback:
            'Needless — hashed URLs change per deploy. This just wastes bandwidth.',
        },
        {
          id: 'c',
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Which files must stay fresh across deploys?',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'No-cache reused-URL files; immutable hashed assets.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Only index.html/config need short TTLs.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'No-cache index.html, keep assets immutable.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: -5,
          reason:
            'The bad TTL stayed in place, priming the next deploy for the same outage.',
        },
      ],
      helpLinks: [
      ...
      successFeedback:
        'Entry files fresh, assets immutable — the class of bug is gone.',
      failureFeedback:
        'No-cache the reused-URL files; leave hashed assets immutable.',
    },
    {
      ...
      tags: ['cicd'],
      storyContext:
        'You still need the fix live now, and a cohort is hitting ChunkLoadError.',
      prompt:
        'What do you do to restore users immediately without new white screens?',
      options: [
        {
          id: 'b',
          ...
          isCorrect: false,
          feedback:
            'Deleting old chunks is exactly what caused the ChunkLoadError; /* is slow and costly.',
        },
        {
          id: 'a',
          label:
            'Invalidate /index.html now, and retain the previous build’s chunks for a grace period so in-flight sessions still resolve',
          isCorrect: true,
          feedback:
            'Invalidating the entry file pushes the new map out; keeping old chunks briefly stops mid-navigation sessions from 404ing.',
        },
        {
          id: 'c',
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Push the new map out, but do not strand active sessions.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'Invalidate index.html; keep old chunks a while.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Grace period for the previous build’s chunks.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Invalidate /index.html and retain old chunks briefly.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: 1,
          reason:
            'A blanket purge with no chunk retention stranded active sessions mid-incident.',
        },
      ],
      helpLinks: [{ topicId: 'cdn.invalidation', label: 'Cache invalidation' }],
      successFeedback:
        'New map live, old chunks retained — users recover with no fresh ChunkLoadErrors.',
      failureFeedback:
        'Invalidate index.html and keep old chunks briefly; do not purge everything.',
    },
    {
      ...
      prompt:
        'How do you confirm — and keep confirming — the new version is served?',
      options: [
        {
          id: 'b',
          ...
          isCorrect: false,
          feedback:
            'Green means the upload ran, not that users are served the new build. That is precisely the gap that caused this incident.',
        },
        {
          id: 'c',
          ...
          isCorrect: false,
          feedback:
            'Manual eyeballing is not repeatable and misses cached cohorts. Automate a real check against the live URL.',
        },
        {
          id: 'a',
          label:
            'Probe the production URL, assert a 200, and check a build/version stamp (or the new hashed asset) so verification proves the live site serves the new build — then bake that check into the deploy job',
          isCorrect: true,
          feedback:
      ...
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'What proves users — not the build machine — have the new version?',
        },
        {
          level: 2,
          title: 'Concept',
          content:
            'Probe the live URL, assert 200, check a version stamp; automate it.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Confirm the served build is the new one, in the pipeline.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Automated smoke test: real URL, 200, build stamp.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: -10,
          reason:
            'With no real verification, nobody could say whether the deploy was actually live.',
        },
      ],
      helpLinks: [
      ...
      failureFeedback:
        'A green pipeline is not proof. Probe the live URL, assert 200, check the build stamp, and automate it.',
    },
  ],
  reflectionPrompt:
