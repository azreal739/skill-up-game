  ...
  challenges: [
    {
      ...
      consequences: [{ type: 'severity', delta: -5, reason: 'Fast diagnosis narrowed the outage to the entry-file cache.' }],
    ...
    },
    {
      ...
      consequences: [{ type: 'stability', delta: 5, reason: 'Correct TTLs stopped the recurring stale-deploy outage.' }],
    ...
    },
    {
      ...
      consequences: [{ type: 'severity', delta: -10, reason: 'Targeted invalidation plus chunk retention restored users without new errors.' }],
    ...
    },
    {
      ...
      consequences: [{ type: 'team-confidence', delta: 10, reason: 'Automated verification made every future deploy provably live.' }],
