...
export const cfMission004Accessibility: MissionDefinition = {
  ...
  summary: 'Keyboard and screen-reader users can’t use the new tile. Sweep the a11y gaps.',
  difficulty: 'medium',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      difficulty: 'medium',
      tags: ['angular', 'a11y'],
      storyContext: 'Three real accessibility problems hide here; one concern is unfounded.',
      ...
      findings: [
        ...
        {
          id: 'no-name',
          label: 'The tile has no accessible name describing what activating it does',
          isCorrect: true,
          feedback:
      ...
      hints: [
        { level: 1, title: 'Direction', content: 'Try to use the tile with only a keyboard, then with your eyes closed.' },
        {
          level: 2,
          title: 'Concept',
          content:
        ...
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Three issues: the clickable div, the missing accessible name, and the colour-only status.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Flag the div-click, the missing name, and the colour-only status. The span is fine.',
        },
      ],
      rewards: [{ type: 'xp', amount: 25, label: 'Swept' }],
      consequences: [
        { type: 'team-confidence', delta: -5, reason: 'An inaccessible component reached QA and had to bounce back.' },
      ],
      helpLinks: [{ topicId: 'a11y.semantics', label: 'Accessible markup and semantics' }],
      successFeedback: 'A real button, a clear name, and status conveyed in more than colour — usable by everyone.',
      failureFeedback: 'Reach for keyboard access, an accessible name, and non-colour status. The span is a red herring.',
    },
  ],
  reflectionPrompt: 'Which is easier: building accessibly from the start, or retrofitting it? Why?',
