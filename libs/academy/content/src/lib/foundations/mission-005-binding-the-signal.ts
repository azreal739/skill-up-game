...
export const mission005BindingTheSignal: MissionDefinition = {
  ...
  summary:
    'The live visitors widget renders garbage. Learn how signals connect state to the view.',
  difficulty: 'easy',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          isCorrect: false,
          feedback:
            'Signals have no .value property — that is a different framework’s API.',
        },
        {
          id: 'c',
          label: '{{ visitors }}',
      ...
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'Look closely at what the template interpolates versus what a signal is.',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'The widget renders a function body on screen. One option adds the missing parentheses.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content:
            'Choose {{ visitors() }} — calling the signal returns its current value and registers the view as a dependent.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: -5,
          reason:
            'The operations page kept rendering a broken visitors widget.',
        },
      ],
      helpLinks: [
      ...
      successFeedback:
        'Calling the signal gives the view a live, reactive value.',
      failureFeedback:
        'A signal is a function that returns its value — the template must call it.',
    },
    {
      ...
      findings: [
        {
          id: 'set-vs-update',
          label:
            'increment() uses set() with the current value instead of update()',
          isCorrect: false,
          feedback:
        ...
        },
        {
          id: 'computed-doubled',
          label:
            'doubled uses computed(), which recalculates on every change — wasteful',
          isCorrect: false,
          feedback:
        ...
        },
        {
          id: 'push-mutation',
          label:
            'history().push(...) mutates the array in place, so the signal never notifies',
          isCorrect: true,
          feedback:
      ...
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'Two rules matter: how signals are read, and how their contents are changed.',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'One issue is in the template line, the other is in how increment() records history.',
        },
        {
          level: 4,
          title: 'Guided solution',
