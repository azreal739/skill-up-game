...
export const helpTopics: HelpTopic[] = [
  ...
  {
    id: 'dance.two-step',
    title: 'Judging the Two Step',
    tags: ['dance', 'judging', 'two-step'],
    summary: 'Two Step: 4/4 quick-quick-slow-slow, a smooth level glide with no bounce, cool effortless character, strongly progressive down the line of dance.',
    content:
      'Two Step (Country/Western Two Step) is in 4/4 with a quick-quick-slow-slow (QQSS) rhythm — two quick steps on the half-beats followed by two slow steps. Do not confuse it with the Triple Two (slow-slow-triple-triple): the Two Step has no triples. Its defining MOTION is a smooth, level, GLIDING drive — long reaching steps that send the couple down the floor with a continuous, engine-like power and NO bounce or up/down pulse (a bounce is the classic motion fault, borrowed from swing). CHARACTER is cool, smooth, easy and effortless — understated country elegance, not flashy or frantic. SIGNATURE FIGURES include promenades, underarm turns, sweethearts, wraps and travelling turns, all of which keep travelling. SPATIAL STRUCTURE is strongly PROGRESSIVE: the couple travels counter-clockwise around the line of dance, covering ground smoothly, so floorcraft matters. Common faults a judge watches for: a bouncy Two Step that has borrowed swing’s pulse instead of gliding, choppy or uneven quicks, a Two Step that stalls and fails to progress down the line, and figures that break the smooth travelling drive.',
  },
  {
    id: 'dance.samba',
    title: 'Judging the Samba',
    tags: ['dance', 'judging', 'samba'],
    summary: 'Samba: 2/4 with a syncopated 1-a-2, a knee-driven Samba bounce, festive carnival character, progressive travel around the floor.',
    content:
      'Samba is a Latin dance in 2/4 with a SYNCOPATED rhythm — the classic basic is counted "1 a 2", splitting the beat unevenly (roughly ¾, ¼, whole) so the "a" is the rhythmic signature. Its defining MOTION is the SAMBA BOUNCE (bounce action): a subtle, controlled down-up pulse generated by the bending and straightening of the KNEES and ankles, tied to the syncopation — NOT a big vertical hop from the upper body. CHARACTER is festive, joyful and carnival — party energy, rhythmic and celebratory. SIGNATURE FIGURES include whisks, samba walks, botafogos and voltas. SPATIAL STRUCTURE is PROGRESSIVE for its travelling figures: the couple moves around the floor along the line of dance (with some spot figures too), so progression and floorcraft both matter. Common faults a judge watches for: a flat, bounce-less Samba that has lost the knee-driven bounce action; an even "1-2" that has lost the syncopated "a"; a bounce faked as a big up-and-down hop from the body instead of the controlled knee pulse; and a subdued Samba lacking its carnival character. Do not confuse it with the Cha Cha (4&5 chasse, Cuban motion, no bounce) — the Samba is defined by its bounce action and 1-a-2 syncopation.',
  },
  {
    id: 'dance.street',
    title: 'Judging Street Styles',
    tags: ['dance', 'judging', 'street'],
    summary: 'Street: a family of SOLO urban styles (popping, locking, waacking, voguing, dancehall) judged on musicality, isolation/execution, and style-appropriate performance.',
    content:
      'Street is not one dance but a FAMILY of solo urban styles — popping, locking, waacking, voguing, illusions, commercial and dancehall — judged as a soloist rather than a lead-follow couple. The six lenses still apply. TIMING is musicality: hitting the accents of the music precisely — a "pop" or "hit" landing exactly on the beat, not early or late. RHYTHM is groove and the pocket: sitting inside the music with syncopation and feel, not just stepping on the beat. MOTION is the technical core — the separation of UPPER vs LOWER core, clean ISOLATIONS, the contract-release muscle "hit" of popping, the freezes of locking, and body illusions; a whole body wobbling when only the chest should move is a control fault. CHARACTER is attitude and performance: each style carries its own — waacking’s dramatic arms, voguing’s sharp lines and drama, dancehall’s grounded groove — and it must be committed and style-appropriate. SIGNATURE FIGURES are the named vocabulary of each style — pops, locks, points and twirls (locking), waacks, vogue elements (hands, catwalk, duckwalk, spins, dips), illusions — plus the foundational foot positions (1st, 2nd, 4th). SPATIAL STRUCTURE is the solo use of performance space: levels (standing, mid, floor), facings toward the audience, and directional variety, rather than travel around a line of dance. The overarching principle is APPROPRIATE STYLING FOR DANCE AND SONG: the style must match the music. Common faults a judge watches for: styling that does not match the song (e.g. a lyrical style over a hard hip-hop track, or dancehall to the wrong music), hits landing off the beat, poor isolation or control, a generic "commercial" mush with no defined style, mislabeled styles (calling locking "popping"), and a soloist who ignores the performance space or turns away from the audience.',
  },
  {
    id: 'dance.stage',
    title: 'Judging Stage and Era Styles',
    tags: ['dance', 'judging', 'stage'],
    summary: 'Stage: era and theatrical styles (Charleston, Lindy, Disco, Bollywood, Broadway, jazz/ballet/modern) judged for era authenticity, clean technical vocabulary and theatrical performance.',
    content:
      'Stage covers ERA and THEATRICAL styles — Charleston, Lindy, Disco, Bollywood, fad dances, Broadway, and the jazz/ballet/modern/contemporary base — judged as a performance number. The six lenses still apply. TIMING is theatrical musicality: hitting the musical structure, phrasing and accents of the number. RHYTHM is the era’s rhythmic feel — the swung 1920s bounce of Charleston, the four-on-the-floor drive of Disco, the specific groove of each period. MOTION is the technical quality of the common stage vocabulary — jumps (elevation and controlled landing), turns (spotting and control), kicks (height and control) — plus era-appropriate body line and styling. CHARACTER is theatrical projection and ERA AUTHENTICITY: embodying the period/genre and projecting it to the house. SIGNATURE FIGURES are each era’s named vocabulary — Charleston swivels and steps, Lindy swing-outs, Disco hustle and points, Bollywood gestures, Broadway staging — plus the shared jumps, turns and kicks. SPATIAL STRUCTURE is stagecraft: use of the whole stage, formations and facings, levels, and projecting to the audience rather than travelling a line of dance. The overarching principle is AUTHENTICITY TO THE ERA/GENRE: the styling must be true to the period being danced. Common faults a judge watches for: wrong-era styling (a Charleston danced with flat modern contemporary lines, or a generic jazz wash instead of true period style), poor technical execution of jumps/turns/kicks (no elevation, no spotting, uncontrolled kicks), a mislabeled era or genre, weak theatrical projection, and a performer who fails to use the stage or turns away from the house.',
  },
];
