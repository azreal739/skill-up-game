...
export const nxMission001AppsVsLibs: MissionDefinition = {
  ...
  title: 'Apps vs Libs',
  summary:
    'The app has swollen with logic that belongs in libraries. Decide what moves.',
  difficulty: 'easy',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      tags: ['nx'],
      storyContext:
        'An app should wire libraries together, not own reusable code.',
      ...
      options: [
        ...
        },
        {
          id: 'a',
          label:
            'The order service, the order models, and the reusable tile — into data-access, util and ui libraries',
          isCorrect: true,
          feedback:
        ...
        },
        {
          id: 'c',
          label:
            'Move the app shell and routes into a library, leave the services in the app',
          isCorrect: false,
          feedback:
            'Backwards — the shell/routing is exactly what stays in the app; the reusable code is what moves out.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'What in here is reused by more than the app itself?',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'The service, models and tile are all reused — they move; the shell stays.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Move the service, models and tile into libraries.',
        },
      ],
      ...
      consequences: [
        {
          type: 'technical-debt',
          delta: 10,
          reason: 'A fat app kept reusable code locked away from other teams.',
        },
      ],
      helpLinks: [{ topicId: 'nx.apps-vs-libs', label: 'Apps vs libraries' }],
      successFeedback:
        'Shell in the app, everything reusable in libraries — the maze begins to open up.',
      failureFeedback:
        'Reusable services, types and UI move to libraries; the app keeps only the shell.',
    },
  ],
  reflectionPrompt:
    'What is currently trapped inside your app that three features would happily share?',
