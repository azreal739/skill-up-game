  ...
  challenges: [
    {
      ...
      options: [
        {
          id: 'a',
          label: 'A libs/ui/order-tile library tagged type:ui — it may depend on util, but not on features or data-access',
          isCorrect: true,
          feedback:
        ...
        },
        {
          ...
          isCorrect: false,
          feedback: 'Feature libraries own flows and data; a reusable presentational tile should stay dumb and UI-tagged.',
        },
        {
          id: 'c',
          label: 'A type:data-access library, since it shows customer data',
          isCorrect: false,
          feedback: 'Showing data is not accessing it — data-access is for services/state, not presentational components.',
        },
      ],
      hints: [
        { level: 1, title: 'Direction', content: 'What kind of thing is a presentational tile?' },
        {
          level: 2,
          title: 'Concept',
          content:
        ...
        { level: 3, title: 'Specific clue', content: 'A dumb, reusable component is type:ui.' },
        { level: 4, title: 'Guided solution', content: 'Place it in a type:ui library.' },
      ],
      rewards: [{ type: 'xp', amount: 10, label: 'Library tagged' }],
      consequences: [{ type: 'technical-debt', delta: 10, reason: 'A mis-tagged UI library was allowed to depend on features.' }],
      helpLinks: [
        { topicId: 'nx.tag-rules', label: 'Tags and boundary rules' },
        { topicId: 'nx.libraries-boundaries', label: 'Nx libraries and boundaries' },
      ],
      successFeedback: 'A ui-tagged library, dependency-light and importable by any feature.',
      failureFeedback: 'A presentational, reusable component is a ui library — not feature or data-access.',
    },
  ],
  reflectionPrompt: 'Why does the library type you choose matter as much as the code inside it?',
