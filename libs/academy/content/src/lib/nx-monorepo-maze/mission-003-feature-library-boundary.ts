  ...
  contextArtefacts: [
    {
      ...
      language: 'ts',
      content:
        "import { formatMoney } from '@org/features/orders'; // reaching into another feature",
    },
  ],
  challenges: [
    {
      ...
      prompt:
        'How should the shared helper be made available to both features?',
      options: [
        {
          id: 'a',
          label:
            'Move formatMoney into a libs/util/money library both features import',
          isCorrect: true,
          feedback:
        ...
        },
        {
          id: 'b',
          label:
            'Add checkout → orders to the allowed dependencies so the import is legal',
          isCorrect: false,
          feedback:
            'Legalising a feature-to-feature dependency spreads the tangle instead of removing it.',
        },
        {
          id: 'c',
          label:
            're-export formatMoney from checkout so others import it from there instead',
          isCorrect: false,
          feedback:
            'That just moves the coupling around — features still depend on each other via re-exports.',
        },
      ],
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'Shared pure helpers have a natural home that is not a feature.',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'formatMoney is a pure function — which library type is that?',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Extract formatMoney to a util library.',
        },
      ],
      ...
      consequences: [
        {
          type: 'technical-debt',
          delta: 15,
          reason: 'A feature-to-feature import tangled two teams’ code.',
        },
      ],
      helpLinks: [
        {
      ...
      successFeedback:
        'The helper lives in util; both features depend inward — no tangle.',
      failureFeedback:
        'Legalising or re-exporting the cross-feature import keeps the coupling. Extract to util.',
    },
  ],
  reflectionPrompt:
    'What makes feature-to-feature dependencies so corrosive as a monorepo scales?',
