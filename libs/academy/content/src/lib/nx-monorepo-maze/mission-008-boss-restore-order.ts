...
export const nxMission008BossRestoreOrder: MissionDefinition = {
  ...
  summary:
    'The monorepo is chaos — fat app, a cycle, slow CI, no rules. Restore order.',
  difficulty: 'boss',
  learningObjectives: [
  ...
  challenges: [
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback:
            'Features importing from the app inverts the dependency direction.',
        },
        {
          id: 'a',
          ...
          isCorrect: true,
          feedback:
            'Shared services belong in a data-access library, out of the thin app.',
        },
        {
          id: 'c',
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'A shared service has a library type.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'Services live in data-access libraries.',
        },
        { level: 3, title: 'Specific clue', content: 'type:data-access.' },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Move it to a data-access library.',
        },
      ],
      ...
      consequences: [
        {
          type: 'technical-debt',
          delta: 10,
          reason: 'A service trapped in the app blocked reuse.',
        },
      ],
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          id: 'a',
          label:
            'Extract the two shared functions into a lower util both depend on',
          isCorrect: true,
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Both could depend on a third thing.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'Extract shared pieces to a lower layer.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Pull the shared functions down.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Extract to a shared lower util.',
        },
      ],
      ...
      consequences: [
        {
          type: 'stability',
          delta: -5,
          reason: 'A hidden cycle kept the build fragile.',
        },
      ],
      ...
      options: [
        {
          id: 'a',
          label:
            'nx affected — changed projects plus their downstream dependents',
          isCorrect: true,
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Build what a change can affect.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'affected = changed + downstream.',
        },
    ...
    },
    {
      ...
      options: [
        {
          id: 'b',
          label:
            'Write a CONTRIBUTING.md asking people not to cross boundaries',
          isCorrect: false,
          feedback:
            'A document enforces nothing; the tangle returns the first busy week.',
        },
        {
          id: 'a',
          label:
            'Tag every project and add enforce-module-boundaries depConstraints that forbid feature→feature and upward deps',
          isCorrect: true,
          feedback:
        ...
        },
        {
          ...
          isCorrect: false,
          feedback:
            'Manual vigilance does not scale and misses cases — automate it.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Make the rules a check, not a hope.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'Tags + enforce-module-boundaries automate architecture.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'The answer involves depConstraints in lint.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Tag projects and add boundary lint rules.',
        },
      ],
      ...
      consequences: [
        {
          type: 'technical-debt',
          delta: 10,
          reason: 'Unenforced rules let the tangle creep back.',
        },
      ],
      helpLinks: [
      ...
      failureFeedback:
        'Docs and manual review do not scale. Encode the boundaries as lint rules.',
    },
  ],
  reflectionPrompt:
