...
export const prodMission001IncidentDeclared: MissionDefinition = {
  ...
  summary: 'Alerts are firing and customers are complaining. Decide the first move of an incident.',
  difficulty: 'easy',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      storyContext: 'Three people guessing in parallel with no coordination is how incidents get longer, not shorter.',
      prompt: 'What is the right first move?',
      options: [
        {
          id: 'a',
          label: 'Declare an incident, name an incident commander, and start a single coordinated channel focused on restoring service',
          isCorrect: true,
          feedback:
        ...
        {
          id: 'b',
          label: 'Let each engineer chase their own theory in parallel — more people means a faster fix',
          isCorrect: false,
          feedback: 'Uncoordinated parallel work causes conflicting changes and missed findings. Someone must coordinate; declare and assign a commander.',
        },
        {
          id: 'c',
          label: 'First find who deployed last so you know who to hold responsible',
          isCorrect: false,
          feedback: 'Hunting for blame in minute one wastes the most valuable time and discourages the honesty you need. Restore service first; the review comes later, blamelessly.',
        },
      ],
      hints: [
        { level: 1, title: 'Direction', content: 'Before fixing, who is coordinating, and toward what goal?' },
        {
          level: 2,
          title: 'Concept',
          content:
        ...
        { level: 3, title: 'Specific clue', content: 'Declare, assign a commander, coordinate — restore first.' },
  ...
  reflectionPrompt: 'Why does naming one commander often make an incident shorter than throwing more engineers at it?',
