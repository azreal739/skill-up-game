...
export const prodMission002ImpactAssessment: MissionDefinition = {
  ...
  summary: 'Before fixing, size the blast radius: who, how badly, and how widely.',
  difficulty: 'easy',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      storyContext: 'Severity is a function of who is affected, how badly, and how widely — not how loud the channel is.',
      prompt: 'How should you assess and classify this incident?',
      options: [
        {
          id: 'a',
          label: 'High severity: a revenue-critical feature is failing for ~30% of all users across all regions; page the right responders and respond aggressively — but note no data corruption, so recovery can focus on availability',
          isCorrect: true,
          feedback:
        ...
        {
          id: 'b',
          label: 'Low severity: 70% of checkouts still succeed, so most users are fine',
          isCorrect: false,
          feedback: 'A 30% failure rate on revenue-critical checkout across all regions is not low. Framing it by the success rate understates a serious, widespread impact.',
        },
        {
          id: 'c',
          label: 'Skip assessment — severity is a guess anyway; just start trying fixes',
          isCorrect: false,
          feedback: 'Without impact assessment you cannot right-size the response or communicate it. Guessing severity wrong in either direction wastes the first minutes.',
        },
      ],
      hints: [
        { level: 1, title: 'Direction', content: 'What determines severity — the loudest voice, or who/how-badly/how-widely?' },
        {
          level: 2,
          title: 'Concept',
          content:
        ...
        { level: 3, title: 'Specific clue', content: 'Revenue-critical + 30% + all regions + no data loss = high severity, availability focus.' },
  ...
  reflectionPrompt: 'How does an honest impact assessment change who you wake up and how you communicate?',
