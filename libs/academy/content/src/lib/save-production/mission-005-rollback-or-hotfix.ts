...
export const prodMission005RollbackOrHotfix: MissionDefinition = {
  ...
  summary:
    'A second service broke without a flag to fall back on. Choose rollback or hotfix.',
  difficulty: 'hard',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      storyContext:
        'A known-good version is one click away; the hotfix is unwritten and untested under incident pressure.',
      prompt: 'What is the right call to restore correct pricing now?',
      options: [
        {
          id: 'a',
          label:
            'Roll back to the known-good v2.2 now to restore service, then write and properly test the fix for v2.4 off the clock',
          isCorrect: true,
          feedback:
        ...
        },
        {
          id: 'b',
          label:
            'Write the 3-line hotfix and push it straight to production — it is only three lines',
          isCorrect: false,
          feedback:
            'An untested change under pressure is exactly how a hotfix becomes a second incident. A known-good rollback exists; use it and test the fix afterwards.',
        },
        {
          id: 'c',
          label:
            'Leave v2.3 running and post a banner telling users totals may be wrong',
          isCorrect: false,
          feedback:
            'Knowingly serving wrong prices is a correctness and trust problem you can end in one click. Roll back rather than asking users to tolerate it.',
        },
      ],
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'What restores correct behaviour fastest with the least new risk?',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'A one-click known-good v2.2 beats an untested 3-line hotfix.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Roll back to v2.2 now; test the real fix afterwards.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: 1,
          reason:
            'An untested change under pressure invited a second incident.',
        },
      ],
      helpLinks: [
      ...
      successFeedback:
        'Rolled back to known-good v2.2 — pricing is correct again, and the real fix ships calmly as v2.4.',
      failureFeedback:
        'A known-good version is one click away. Roll back to restore service; don’t gamble on an untested hotfix.',
    },
  ],
  reflectionPrompt:
    'When is a hotfix actually the right call over a rollback — and how rarely is that during the incident itself?',
