...
export const prodMission006CommunicationUpdate: MissionDefinition = {
  ...
  summary: 'Support and leadership are asking for an update. Write one that helps, in user terms.',
  difficulty: 'medium',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      storyContext: 'A good update states impact in user terms, what you are doing, and when the next update lands.',
      prompt: 'Which update should you post?',
      options: [
        {
          id: 'a',
          label: '"Some customers experienced checkout failures starting ~14:02. We identified the cause, mitigated it, and checkout is recovering. Next update in 20 minutes." — impact, action, and a next-update time',
          isCorrect: true,
          feedback:
        ...
        {
          id: 'b',
          label: '"TypeError in checkout-service v4.7 on host prod-ckt-3; rolled back pricing v2.3→v2.2; Dan’s deploy caused it." — full technical detail',
          isCorrect: false,
          feedback: 'Too internal for a public/leadership audience, leaks hostnames and a version map, and names an individual — premature blame. Keep it user-focused and blameless.',
        },
        {
          id: 'c',
          label: 'Post nothing until the incident is fully resolved, to avoid saying something you might correct later',
          isCorrect: false,
          feedback: 'Silence during an incident is its own second incident — support and customers assume the worst. A steady cadence, even "no change yet", builds trust.',
        },
      ],
      hints: [
        { level: 1, title: 'Direction', content: 'Who is the audience, and what do they actually need to hear?' },
        {
          level: 2,
          title: 'Concept',
          content:
        ...
        { level: 3, title: 'Specific clue', content: 'Impact + action + next-update time, in user terms.' },
  ...
  reflectionPrompt: 'Why is "no change yet, next update in 20 minutes" a better message than silence?',
