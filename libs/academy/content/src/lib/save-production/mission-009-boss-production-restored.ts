  ...
  challenges: [
    {
      ...
      consequences: [{ type: 'severity', delta: -5, reason: 'Declaring and coordinating immediately kept the Sev1 focused.' }],
    ...
    },
    {
      ...
      consequences: [{ type: 'severity', delta: -5, reason: 'Data-led diagnosis avoided restarting healthy infrastructure.' }],
      helpLinks: [
    ...
    },
    {
      ...
      consequences: [{ type: 'severity', delta: -15, reason: 'A one-click rollback ended the outage without a risky overnight hotfix.' }],
    ...
    },
    {
      ...
      consequences: [{ type: 'stability', delta: 15, reason: 'Validation, communication and a systemic action item closed the incident and hardened the pipeline.' }],
      helpLinks: [
