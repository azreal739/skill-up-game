...
export const ttMission004Generic: MissionDefinition = {
  ...
  summary:
    'A shared helper returns any, poisoning every caller. Make it generic.',
  difficulty: 'medium',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      tags: ['typescript'],
      storyContext:
        'first(customers) should return Customer | undefined, not any.',
      prompt: 'Which signature preserves the caller’s element type?',
      options: [
        {
          id: 'b',
          label:
            'export function first(items: unknown[]): unknown {\n  return items[0];\n}',
          isCorrect: false,
          feedback:
        ...
        },
        {
          id: 'c',
          label:
            'export function first(items: any[]): any { return items[0]; } // add a JSDoc @returns',
          isCorrect: false,
          feedback:
            'A comment does not restore type safety — the return is still any and typos still compile.',
        },
      ],
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'The return type should match whatever element type was passed in.',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'The right signature has <T>, takes T[] and returns T | undefined.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Make first generic over T.',
        },
      ],
      ...
      consequences: [
        {
          ...
          delta: 10,
          reason:
            'An any-returning helper spread untyped values across callers.',
        },
      ],
      helpLinks: [
      ...
      successFeedback:
        'The generic preserves each caller’s type — typos downstream now fail to compile.',
      failureFeedback:
        'unknown and comments both drop the element type. A generic <T> carries it through.',
    },
  ],
  reflectionPrompt:
    'Which shared helpers in your code return any and quietly weaken every caller?',
