...
export const ttMission005OptionalTrap: MissionDefinition = {
  ...
  title: 'Optional Trap',
  summary:
    'Optional fields are accessed as if they always exist. Defuse the traps.',
  difficulty: 'medium',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      tags: ['typescript'],
      storyContext:
        'Two lines assume optional data exists; one is actually safe.',
      prompt:
        'Select every line that will crash when the optional data is missing.',
      findings: [
        {
          id: 'name-initial',
          ...
          isCorrect: false,
          feedback:
            'name is a required non-optional string here; indexing a required string is safe in this model.',
        },
        {
          id: 'lastlogin',
          label:
            'this.user.lastLogin!.getFullYear() assumes an optional date exists',
          isCorrect: true,
          feedback:
      ...
      hints: [
        {
          ...
          title: 'Direction',
          content:
            'Find the fields declared with ? and see how they are accessed.',
        },
        {
          level: 2,
          title: 'Concept',
        ...
        },
        {
          ...
          title: 'Specific clue',
          content:
            'Two optional fields (address, lastLogin) are accessed with !.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content:
            'Flag the address! and lastLogin! lines. name is required and safe.',
        },
      ],
      ...
      consequences: [
        {
          type: 'stability',
          delta: -10,
          reason: 'The profile page kept crashing for users with sparse data.',
        },
      ],
      helpLinks: [
        {
      ...
      successFeedback:
        'Optional data is now handled deliberately — no more crashes on absent fields.',
      failureFeedback:
        'Look for ! on fields declared optional with ?. The required name is the safe one.',
    },
  ],
  reflectionPrompt:
    'Why does the ! operator so often turn a caught bug into an uncaught one?',
