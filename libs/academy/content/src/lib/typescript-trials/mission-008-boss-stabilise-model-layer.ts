...
export const ttMission008BossStabilise: MissionDefinition = {
  ...
  summary:
    'Defects are escaping through a weakly-typed model layer. Stabilise it end to end.',
  difficulty: 'boss',
  learningObjectives: [
  ...
  challenges: [
    {
      ...
      options: [
        {
          id: 'a',
          label:
            'Accept json: unknown and validate it into an Order before returning',
          isCorrect: true,
          feedback:
            'unknown forces validation at the boundary — no untyped value reaches consumers.',
        },
        {
          id: 'b',
          ...
          isCorrect: false,
          feedback:
            'any + cast is the original sin — it asserts a shape without checking it.',
        },
        {
          id: 'c',
          ...
          isCorrect: false,
          feedback:
            'Claiming the raw input is already an Order is the same lie as the cast.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'External input should be unknown until proven.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'unknown + validation guards the boundary.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'The safe option validates before returning.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Take unknown and validate into an Order.',
        },
      ],
      ...
      consequences: [
        {
          type: 'stability',
          delta: -5,
          reason: 'An unvalidated cast let malformed orders through.',
        },
      ],
      helpLinks: [
      ...
      failureFeedback:
        'any and direct-typing both skip validation. Use unknown and check.',
    },
    {
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback:
            'Any string, including typos, remains valid — no safety gained.',
        },
        {
          id: 'a',
          label:
          ...
          isCorrect: true,
          feedback:
            'A union restricts status to real states and makes switches exhaustive.',
        },
        {
          id: 'c',
      ...
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'List the real states as a type.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'A union is a checked vocabulary.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'The answer enumerates the valid statuses.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Define a union of the valid statuses.',
        },
      ],
      ...
      consequences: [
        {
          type: 'stability',
          delta: -5,
          reason: 'A loose status string let typos ship.',
        },
      ],
    ...
    },
    {
      ...
      tags: ['typescript'],
      storyContext:
        'A consumer must read a field that only exists on paid orders.',
      ...
      options: [
        {
          ...
          isCorrect: false,
          feedback:
            'A cast asserts the variant without checking — crashes on non-paid orders.',
        },
        {
          id: 'c',
          ...
          isCorrect: false,
          feedback:
            'The ! asserts presence and throws when the order is not paid.',
        },
        {
          id: 'a',
          ...
          isCorrect: true,
          feedback:
            'Narrowing on the discriminant makes the paid-only field safe to read.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'Check the status before reading paid-only fields.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'Discriminant narrowing makes variant fields safe.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: "The safe option checks status === 'paid' first.",
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Narrow on status before using paidAt.',
        },
      ],
      ...
      consequences: [
        {
          type: 'stability',
          delta: -5,
          reason: 'A cast read a field missing on unpaid orders.',
        },
      ],
    ...
    },
    {
      ...
      options: [
        {
          ...
          isCorrect: true,
          feedback:
            'The generic preserves each caller’s type, ending the any leak across the whole layer.',
        },
        {
          id: 'b',
        ...
        },
        {
          id: 'c',
          label:
            'function pick(items: unknown[]): unknown { return items[0]; }',
          isCorrect: false,
          feedback:
            'Safer than any but still drops the element type; callers must re-narrow.',
        },
      ],
      hints: [
        {
          level: 1,
          title: 'Direction',
          content: 'The return type should match the element type passed in.',
        },
        {
          level: 2,
          title: 'Concept',
          content: 'A generic carries the caller’s type through.',
        },
        {
          level: 3,
          title: 'Specific clue',
          content: 'Look for <T>, T[] and T | undefined.',
        },
        {
          level: 4,
          title: 'Guided solution',
          content: 'Make pick generic over T.',
        },
      ],
      ...
      consequences: [
        {
          type: 'technical-debt',
          delta: 10,
          reason: 'An any-returning helper kept leaking untyped values.',
        },
      ],
      ...
      failureFeedback:
        'any and unknown both drop the element type. A generic preserves it.',
    },
  ],
  reflectionPrompt:
